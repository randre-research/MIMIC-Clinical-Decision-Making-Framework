...
class EmbeddingModelContainer:
    ...
    def rank_texts(self, query, texts):
        """
        MedCPT Cross-Encoder approach for scoring (ranking) a list of texts against a given query. 
        Returns logits for each [query, text] pair.
        """
        ...
        # Return logits as a CPU numpy array for convenience
